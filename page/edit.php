...
while($arr = mysqli_fetch_array($rst)) {
	...
	$arr_date = $arr['date'];
	$arr_description = $arr['description'];
...
<form method="post" action="/post">
	<div class="form-group">
		...
		<input id="titre" class="form-control" name="title" type="text" value="<?php echo $arr_title ?>" />
	</div>
	<div class="form-group">
		<label for="date">date</label>
		<input id="date" class="form-control" name="date" type="datetime" value="<?php echo $arr_date ?>" />
	</div>
	<div class="form-group">
		<label for="description">description</label>
		<textarea id="description" class="form-control" name="description"><?php echo $arr_description?></textarea>
	</div>
	<div class="form-group">
		<label for="tag">define your tags</label>
		<input id="tag" class="form-control" name="tag" type="text" value="<?php echo $arr_tag ?>" />
	</div>
 	<div class="input-group">
		<label for="category">define your categories</label>
		<?php echo toSELECT($arr_tree, 0, 'category_parent[]',$arr_name); ?>
