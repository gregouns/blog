...
$rst = mysqli_query($cnt,$query);
echo '<label for="tag">tag</label><br/><u>Ajouter des tags parmis les tags existants :</u>';
echo '<div id="alltag">';
...
<u>ou ajouter de nouveaux tags :</u>
...
<u>Vos tags sélectionnés:</u>
<div id="newtag" style="padding: 20px; border:1px solid #ccc; background: #eee;"></div>
<input id="toinsert" name="newtag" type="hidden" value="" />
<hr /><br /><br />
<?php 	
if(isset($name)){
